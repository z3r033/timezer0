...
public class deleteProjectUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_project_user);
        Intent intent = getIntent();
        project_id = intent.getLongExtra("project_id",0);

        TextInputEditText searchcontact = (TextInputEditText) findViewById(R.id.search_utilisateurprojectdel);
        searchcontact.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                (deleteProjectUserActivity.this).adapter.getFilter().filter(s);
            }
        ...
        mListView = (ListView) findViewById(R.id.list_utilisateursprojectdel);

        refresh = (SwipeRefreshLayout) findViewById(R.id.swiperefreshutilisateursdel);
        refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                new Dowloader(deleteProjectUserActivity.this, jsonURL, mListView).execute();
    ...
    private class Dowloader extends AsyncTask<Void, Integer, String> {
        ...
        private String downloadContact() {
            ...
            String jurl= "http://10.0.0.1:8080/usersproject/notin?project_id="+project_id;
...
//Toast.makeText(Contact.this,contact.get(0).getEmail(),Toast.LENGTH_LONG).show();
    ...
    private class CustomAdapterProject extends BaseAdapter implements Filterable {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(mContext).inflate(R.layout.delete_userproject_row, parent, false);
            }
            ImageView imageprofile = (ImageView) convertView.findViewById(R.id.profile_urldel);
            TextView txtusername = (TextView) convertView.findViewById(R.id.usernameprodel);
            TextView txtemail =(TextView) convertView.findViewById(R.id.emailadduserprojectdel);
            MaterialButton btnajouter = (MaterialButton) convertView.findViewById(R.id.ajouterprojectuserdel);
            ...
            final String utilisateur_id = SharedPref.readSharedSetting(mContext, "userid", "0");
if(contact_id.equals(utilisateur_id)){
    btnajouter.setText("quitter");
}
            ...
            btnajouter.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(deleteProjectUserActivity.this);
                    builder.setMessage("tu est sure que vous voulez supprimer ce contact?")
                            .setCancelable(false)
                            .setPositiveButton("oui", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    new deletecontact(getApplicationContext(),project_id,contact_id).execute();
                                    new Dowloader(deleteProjectUserActivity.this, jsonURL, mListView).execute();
                                }
                            })
        ...
        private class deletecontact extends AsyncTask <Void,Void,String> {
            ...
            Context ct;
            public deletecontact(Context ctx, Long project_id ,String utilisateur_id) {
            ...
            private String send() {
                final String token = SharedPref.readSharedSetting(mContext, "token", "0");
                Object mconnect = connect.connect("http://10.0.0.1:8080/project_users/delete",token);
